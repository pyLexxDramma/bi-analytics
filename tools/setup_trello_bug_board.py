...
1. Новые заявки с ai.conall.ru падают в **Анализ** (первая колонка, сверху; метка по типу).
...
| Кнопка | Действие |
|--------|----------|
| → Вопрос | переместить в список «Вопросы» |
| → Фича | переместить в список «Фичи» |
| → UI | переместить в список «UI/UX» |
| → Баг | переместить в список «Баги» |
| → Срочно | переместить в список «Срочно» |
| → В работу | переместить в список «В работе» |
| → Холд | переместить в список «На холде» |
| → Готово | переместить в список «Готово» |
