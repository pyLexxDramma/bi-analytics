...
_TABLE_CSS_LIGHT = (
    ...
    "border-bottom:2px solid #cbd5e1;font-weight:600;white-space:normal;word-wrap:break-word;overflow-wrap:anywhere;line-height:1.25;max-width:11em;overflow:visible;text-overflow:clip;vertical-align:bottom}"
    ...
    ".ht th.col-text,.ht td.col-text{text-align:left;vertical-align:top}"
    ".ht th{text-align:center!important}"
    ".ht tr:hover td{background:#f3f4f6}"
    "</style>"
)
