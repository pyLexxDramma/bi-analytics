...
_MSP_COL_MAP = {
    ...
    # Варианты с пробелами и англ. заголовки MS Project (§5.1, смена выгрузки)
    "Процент завершения":    "pct_complete",
    "Базовая длительность":  "base_duration",
    "Базовое начало":        "base_start",
    "Базовое окончание":     "base_finish",
    "Уровень структуры":     "level_structure",
    "Причины отклонений":    "deviation_reason",
    "Дата ограничения":      "constraint_date",
    "Шифр ПД и РД":          "cipher",
    "Режим задачи":          "task_mode",
    "Календарь задачи":      "calendar",
    "Отклонение начала":     "deviation_start_days",
    "Отклонение окончания":  "deviation_finish_days",
    "Уникальный идентификатор": "unique_id",
    "Percent Complete":      "pct_complete",
    "Baseline Duration":     "base_duration",
    "Baseline Start":        "base_start",
    "Baseline Finish":       "base_finish",
    "Start":                 "start",
    "Finish":                "finish",
    "Duration":              "duration",
    "Name":                  "name",
