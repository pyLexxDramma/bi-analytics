...
def main():
    ...
    if has_any_data:
        ...
        **Сроки (по правкам):**
        - **Причины отклонений** (вкладки: доли причин, динамика по периодам, динамика причин), **Отклонение от базового плана**, **Контрольные точки**, **График проекта**

        **Финансы:**
        - **БДДС**, **БДР**, **Бюджет план/факт**, **Утверждённый бюджет**, **Прогнозный бюджет**, **ДЗ/КЗ подрядчиков**

        **Прочее:**
        - Девелоперские проекты, предписания, исполнительная документация, график движения рабочей силы, проектные работы
