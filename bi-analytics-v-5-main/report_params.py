...
PREDEFINED_PARAMETERS = {
    ...
    # Задача для метрик «окончание проекта» — только в админке (settings.baseline_plan_task_for_metrics),
    # не в параметрах отчёта для аналитиков.
    "Отклонение от базового плана": []
}

# Обратная совместимость со старым названием отчёта в БД/настройках
PREDEFINED_PARAMETERS["Прогнозный бюджет"] = PREDEFINED_PARAMETERS[
    "БДДС расходы (план, факт, уточненный план)"
]
