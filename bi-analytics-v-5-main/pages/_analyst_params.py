...
if is_streamlit_context():
    # Настройка страницы
    st.set_page_config(
        page_title="Административная панель - BI Analytics",
        page_icon="⚙️",
        layout="wide",
        menu_items={
            'Get Help': None,
    ...
    if not has_admin_access(user['role']):
        ...
        st.info("Доступ к административной панели имеют только администраторы и суперадминистраторы.")
    ...
    tab_filters, tab_system = st.tabs(["Фильтры отчетов", "Управление системой"])
